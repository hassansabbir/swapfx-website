...
import { AlertCircle, ArrowLeft, CheckCircle2, ChevronLeft, Shield, X, Check } from "lucide-react";
...
export default function MembershipFlowPage() {
  ...
  const [selectedPayment, setSelectedPayment] = useState<"stripe" | "razorpay">("stripe");
  ...
  return (
    <div className="py-6 md:py-10 px-3 md:px-8 max-w-[1000px] mx-auto w-full animate-in fade-in duration-500">
      <GlassContainer className="p-6 md:p-12 relative bg-white/40 border border-white/60 shadow-2xl rounded-4xl flex flex-col justify-center min-h-[500px]">
        ...
        {(viewState === "silver" || viewState === "gold_active" || viewState === "success") && (
          <button
            onClick={() => router.back()}
        ...
        {viewState === "silver" ? (
          ...
          <div className="max-w-[650px] mx-auto w-full space-y-6 pt-2 animate-in fade-in duration-300">
            ...
            <div className="bg-white/80 backdrop-blur-md rounded-3xl p-8 md:p-10 border border-slate-200/60 shadow-[0_4px_25px_rgba(0,0,0,0.01)] flex flex-col items-center max-w-[550px] mx-auto">
              ...
              <h3 className="text-[1.3rem] font-bold text-slate-600 mb-1">Silver</h3>
              <p className="text-[1.05rem] text-slate-700 font-medium mb-8">You're a Silver Member</p>
              ...
              <div className="w-full space-y-4 mb-10">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3">
                    <CheckCircle2 size={20} className="text-white fill-[#09A6A4] shrink-0 mt-0.5" />
                    <span className="text-[0.9rem] text-slate-700 font-medium leading-snug">{feature}</span>
                  </div>
                ))}
              </div>
              ...
              <button 
                ...
                className="w-full max-w-[300px] py-3.5 rounded-lg text-[0.95rem] font-bold bg-[#09A6A4] text-white shadow-lg shadow-[#09A6A4]/20 hover:scale-[1.02] transition-transform"
              >
                Upgrade to Gold
              </button>
            </div>
          ...
          <div className="max-w-[750px] mx-auto w-full space-y-6 pt-4 relative animate-in fade-in duration-300">
            ...
            <div className="bg-white/80 backdrop-blur-md rounded-3xl p-8 md:p-10 border border-slate-200/60 shadow-[0_4px_25px_rgba(0,0,0,0.01)] flex flex-col items-center max-w-[650px] mx-auto">
              ...
              <h3 className="text-[1.3rem] font-bold text-[#09A6A4] mb-1">Gold</h3>
              <p className="text-[1.05rem] text-slate-800 font-bold mb-6">Become a Gold member</p>

              {/* Pricing Text */}
              <div className="text-center mb-8 space-y-1">
                <div className="flex items-end justify-center gap-1">
                  <span className="text-[1.8rem] font-bold text-[#09A6A4]">£2.99</span>
                  <span className="text-[0.9rem] text-slate-500 font-medium pb-1.5">/ month</span>
                </div>
                <div className="flex items-end justify-center gap-1">
                  <span className="text-[1.1rem] font-bold text-[#09A6A4]">£33.99</span>
                  <span className="text-[0.85rem] text-slate-500 font-medium pb-0.5">/ year</span>
                </div>
              </div>
          ...
          <div className="max-w-[750px] mx-auto w-full space-y-6 pt-4 relative animate-in fade-in duration-300">
            ...
            <div className="max-w-[650px] mx-auto w-full space-y-5">
              ...
              <div className="space-y-1">
                <h3 className="text-[1.1rem] font-bold text-slate-800">Choose your subscription plan</h3>
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="space-y-2">
                    <div className="space-y-0.5">
                      <h4 className="font-bold text-slate-800 text-[1.05rem]">Monthly</h4>
                      <p className="text-[0.8rem] text-slate-500 font-medium">Billed monthly</p>
                    </div>
                    <div className="flex items-end gap-1.5">
                      <span className="text-[1.3rem] font-bold text-[#09A6A4]">£2.99</span>
                      <span className="text-[0.8rem] text-slate-500 font-medium pb-1">per month</span>
                    </div>
                  </div>
                  {selectedPlan === "monthly" ? (
                    <CheckCircle2 size={24} className="text-white fill-[#09A6A4]" />
                  ) : (
                ...
                >
                  ...
                  <div className="space-y-2">
                    <div className="space-y-0.5">
                      <h4 className="font-bold text-slate-800 text-[1.05rem]">Yearly</h4>
                      <p className="text-[0.8rem] text-slate-500 font-medium">Billed annually</p>
                    </div>
                    <div className="space-y-0.5">
                      <div className="flex items-end gap-1.5">
                        <span className="text-[1.3rem] font-bold text-[#09A6A4]">£33.99</span>
                        <span className="text-[0.8rem] text-slate-500 font-medium pb-1">per year</span>
                      </div>
                      <p className="text-[0.75rem] text-slate-400 font-medium">£2.83/month when billed annually</p>
                    </div>
                  </div>
                  {selectedPlan === "yearly" ? (
                    <CheckCircle2 size={24} className="text-white fill-[#09A6A4]" />
              ...
              <div className="bg-[#EBF5FF] border border-[#BFDBFE] rounded-xl p-5 space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-[#1E3A8A] text-[0.85rem]">Important Notes:</span>
                </div>
                <ul className="list-disc pl-5 space-y-1.5 text-[0.8rem] text-[#1E40AF] font-medium leading-relaxed">
                  <li>Refunds for cancelled annual memberships are issued based on the remaining unused months.</li>
                  <li>Subscription starts immediately and payments are collected on the same date each month or year.</li>
                  <li>Failure to pay the subscription fee will result in automatic cancellation of Gold membership after 14 days.</li>
                  <li>Account will be downgraded to Silver if payment is missed.</li>
                  <li>Missed payments can be settled within 14 days to bring your account up to date and restore benefits.</li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-5 mt-4 space-y-4 shadow-sm">
                <div className="flex justify-between items-center text-[0.85rem]">
                  ...
                  <span className="font-bold text-slate-800">Gold Membership</span>
                </div>
                <div className="flex justify-between items-center text-[0.85rem]">
                ...
                <div className="flex justify-between items-end">
                  <span className="font-bold text-slate-800 text-[0.95rem]">Total</span>
              ...
              <div className="pt-3 pb-2 flex justify-center">
                <button 
                  ...
                  className="w-full max-w-[400px] py-3.5 rounded-lg text-[0.95rem] font-bold bg-[#09A6A4] text-white shadow-lg shadow-[#09A6A4]/20 hover:scale-[1.02] transition-transform"
                >
                  Subscribe
                </button>
              </div>
          ...
          <div className="max-w-[750px] mx-auto w-full space-y-6 pt-4 relative animate-in fade-in duration-300">
            ...
            <div className="max-w-[500px] mx-auto w-full space-y-5">
              <h3 className="font-bold text-slate-800 text-[1rem]">Payment Method</h3>
              ...
              <div className="space-y-3">
                ...
                >
                  <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${selectedPayment === "stripe" ? "border-[#09A6A4]" : "border-slate-300"}`}>
                    {selectedPayment === "stripe" && <div className="w-2.5 h-2.5 rounded-full bg-[#09A6A4]" />}
                  </div>
                ...
                >
                  <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${selectedPayment === "razorpay" ? "border-[#09A6A4]" : "border-slate-300"}`}>
                    {selectedPayment === "razorpay" && <div className="w-2.5 h-2.5 rounded-full bg-[#09A6A4]" />}
                  </div>
              ...
              <div className="pt-6 flex justify-center">
                <button 
                  ...
                  className="w-full max-w-[280px] py-3.5 rounded-lg text-[0.95rem] font-bold bg-[#09A6A4] text-white shadow-lg shadow-[#09A6A4]/20 hover:scale-[1.02] transition-transform"
                >
                  Pay
                </button>
              </div>
          ...
          <div className="max-w-[750px] mx-auto w-full space-y-6 pt-4 relative animate-in fade-in duration-300">
            ...
            <div className="max-w-[650px] mx-auto w-full space-y-6 pt-10">
              <div className="space-y-3">
                <h3 className="text-[1.25rem] font-bold text-slate-800">Cancel Gold membership?</h3>
                <p className="text-[0.9rem] text-slate-600 font-medium leading-relaxed">
                  We're sorry to see you go. If you cancel, you'll lose access to Gold benefits after your current billing period ends on <span className="font-bold">April 17, 2026</span>.
                </p>
              </div>
              ...
              <div className="bg-[#FEF2F2] border border-[#FECACA] rounded-xl p-6 space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-[#991B1B] text-[0.9rem]">After April 17, 2026, you'll lose:</span>
                </div>
                <div className="space-y-2.5">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3">
                      ...
                      <span className="text-[0.85rem] text-[#991B1B] font-medium">{item}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-white border border-slate-200 shadow-sm rounded-xl p-6 space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-slate-800 text-[0.9rem]">You'll still have Silver membership:</span>
                </div>
                <div className="space-y-2.5">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3">
                      <CheckCircle2 size={16} className="text-slate-200 fill-slate-400" />
                      <span className="text-[0.85rem] text-slate-600 font-medium">{item}</span>
                    </div>
                  ))}
                </div>
              </div>
