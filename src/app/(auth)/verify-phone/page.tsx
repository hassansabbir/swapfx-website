...
export default function PhoneOTPPage() {
  ...
  return (
    <div className="relative w-full max-w-[750px] bg-white/10 backdrop-blur-2xl rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-10 md:p-16 shadow-2xl border border-white/20 flex flex-col items-center animate-in fade-in zoom-in duration-500">
      {/* Back Button */}
      <IconButton href="/register-phone" className="absolute top-5 left-5 sm:top-8 sm:left-8 bg-slate-400/50 hover:bg-slate-500/50">
        <ChevronLeft className="w-6 h-6" />
      </IconButton>

      <div className="w-full max-w-[500px] mt-8 text-center space-y-8">
        <div className="space-y-3">
          <h2 className="text-[1.5rem] font-bold text-slate-800">Phone OTP</h2>
          <p className="text-[0.95rem] text-slate-500 max-w-[400px] mx-auto leading-relaxed">
            Your OTP has been sent to your registered phone number. Enter it
            below to continue.
          </p>
        </div>
